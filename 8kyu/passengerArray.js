...
represent the number of people that get on the bus (the first item) and the number of 
people that get off the bus (the second item) at a bus stop.
...
not be empty and some people might still be inside the bus, they are probably sleeping 
there :D
